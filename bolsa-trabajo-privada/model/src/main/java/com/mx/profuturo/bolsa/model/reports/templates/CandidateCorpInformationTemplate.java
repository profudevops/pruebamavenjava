...
public class CandidateCorpInformationTemplate extends CandidateInfoBaseTemplate implements XLSTemplate {

    public CandidateCorpInformationTemplate(String branch) {
        this.mode = branch;
    }
    ...
    protected Row getXLSCOMHeaders(Row row, Sheet s, Integer p) {
        ...
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("Filtro Telefonico");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("descarteTelefonico");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("tipoPrimerEntrevista");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("fechaPrimerEntrevista");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("horaPrimerEntrevista");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("resultadoPrimerEntrevista");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("motivoDescartePrimerEntrevista");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("comentariosPrimerEntrevista");
        // s.autoSizeColumn(p);
        ...
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("Examen de confianza");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("Resultado examen de confianza");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("Psicometrico");
        // s.autoSizeColumn(p);
        row.createCell(p++).setCellValue("Resultado Psicometrico");
        // s.autoSizeColumn(p);
