...
public class CandidateComInfo extends DatosFiltrosVO {
    ...
    public String getAmitai() {
        return amitai;
    }

    public void setAmitai(String amitai) {
        this.amitai = amitai;
    }
