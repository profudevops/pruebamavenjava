<template>
  <div>
    ...
    <slot v-if="!loadingReasons">
      ...
      >
        <p>El candidato fue aprobado por el Gerente. Puedes hacerle una oferta.</p>

        <!-- Continue -->
        <b-form-group
          label="El candidato aceptó la oferta"
