        ...
        >
          <div class="select-wrapper hour-select">
            ...
            >
              ...
              <option v-for="hour in horas" :key="hour.codigo" :value="hour.id">
                {{
                hour.descripcion
                }}
              </option>
      ...
      if (this.form.fecha) {
        prospectSrv
          .getSchedules({
            ...
            idConsultor: this.info.idConsultor,
