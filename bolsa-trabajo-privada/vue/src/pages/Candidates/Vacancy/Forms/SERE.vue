  ...
  <div>
    ...
    <slot v-if="!loadingReasons">
      ...
      >
        <!-- Continue -->
        <b-form-group
          label="Resultado entrevista del área"
        ...
        <!-- Comments -->
        <b-form-group class="required" label="Comentarios (opcional)">
          <b-form-textarea
            required
            name="comentarios"
